...
import com.example.uehnews.EmptyRecyclerView;
...
import com.example.uehnews.adapter.NewsAdapter;
...
public class BaseArticlesFragment extends Fragment
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        ...
        String uriBuilder = NewsPreferences.getPreferredUri(getContext());

        // Create a new loader for the given URL
        return new NewsLoader(getActivity(), uriBuilder);
    }
